...
class IPPerfMonitor(object):
    """
    Decorator that keeps track of the number of times a function is called and collects additional information like arguments, return value, and time spent in the function
    """
